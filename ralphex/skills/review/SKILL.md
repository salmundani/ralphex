...
4. Verify the working tree is clean with `git status`. If there are uncommitted changes, inform the user that uncommitted changes exist and they must be committed before running this command, then stop.
